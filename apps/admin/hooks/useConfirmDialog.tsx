...
const StyledContentDiv = styled.div`
  ...
  .MuiDialogContent-root {
    padding: ${({ isHeader }: { isHeader?: boolean }) =>
        isHeader ? '2rem' : '4rem'}
      1rem 1rem 1rem;
  }
  .close-button {
...
const useConfirmationDialog = () => {
  ...
  const renderConfirmationDialog = () => {
    return (
      ...
      >
        <StyledContentDiv isHeader={Boolean(dialogProps.title)}>
  ...
  //! We Replace this function with JSX Element instead of calling directly we will return JSX. FOr more Info visist docs.
  //? V2
  const RenderConfirmationDialog = () => renderConfirmationDialog();
